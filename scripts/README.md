...
This kit is a content product — docs, prompts, context-packs, and customer
overlays. Its "tests" are the **static / doc** consistency gates
...
When you add a prompt, doc, or overlay key, run the validator
