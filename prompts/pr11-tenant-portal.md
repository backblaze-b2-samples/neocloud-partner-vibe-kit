...
Use this prompt with Claude for PR 11.
...
Add tenant-facing self-service workflows.

## Scope

Projects, uploads, objects, API keys, usage, report downloads, logical file browser.
...
- tenant sees only own metadata
- logical paths displayed
- API key lifecycle
- usage reports scoped
